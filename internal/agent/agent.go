...
import (
	...
	"github.com/cliftondavies/log/internal/auth"
	"github.com/cliftondavies/log/internal/discovery"
	"github.com/cliftondavies/log/internal/log"
...
func New(config Config) (*Agent, error) {
	...
	setup := []func() error{a.setupLogger, a.setupMux, a.setupLog, a.setupServer, a.setupMembership}
